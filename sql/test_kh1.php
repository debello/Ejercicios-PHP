...
/* changed 'worldwide' field to INTEGER and deleted all the $ symbols
so I can manipulate the data (sum, average, min, max...)

also deleted commas in worldwide and overseas_moneys fields*/
...
INSERT INTO top_movies(rank,title,studio,worldwide,domestic_money,domestic_percent,overseas_money,overseas_percent,year) VALUES ('1','Avatar','Fox','2788.0','760.5','27.3%','2027.5','72.7%','2009^');
INSERT INTO top_movies(rank,title,studio,worldwide,domestic_money,domestic_percent,overseas_money,overseas_percent,year) VALUES ('2','Titanic','Par.','2186.8','658.7','30.1%','1528.1','69.9%','1997^');
INSERT INTO top_movies(rank,title,studio,worldwide,domestic_money,domestic_percent,overseas_money,overseas_percent,year) VALUES ('3','Marvel''s The Avengers','BV','1518.6','623.4','41.0%','895.2','59.0%','2012');
INSERT INTO top_movies(rank,title,studio,worldwide,domestic_money,domestic_percent,overseas_money,overseas_percent,year) VALUES ('4','Harry Potter and the Deathly Hallows Part 2','WB','1341.5','381.0','28.4%','960.5','71.6%','2011');
INSERT INTO top_movies(rank,title,studio,worldwide,domestic_money,domestic_percent,overseas_money,overseas_percent,year) VALUES ('5','Furious 7','Uni.','1322.2','321.2','24.3%','1001.0','75.7%','2015');
INSERT INTO top_movies(rank,title,studio,worldwide,domestic_money,domestic_percent,overseas_money,overseas_percent,year) VALUES ('6','Frozen','BV','1274.2','400.7','31.4%','873.5','68.6%','2013');
INSERT INTO top_movies(rank,title,studio,worldwide,domestic_money,domestic_percent,overseas_money,overseas_percent,year) VALUES ('7','Iron Man 3','BV','1215.4','409.0','33.7%','806.4','66.3%','2013');
INSERT INTO top_movies(rank,title,studio,worldwide,domestic_money,domestic_percent,overseas_money,overseas_percent,year) VALUES ('8','Transformers: Dark of the Moon','P/DW','1123.8','352.4','31.4%','771.4','68.6%','2011');
INSERT INTO top_movies(rank,title,studio,worldwide,domestic_money,domestic_percent,overseas_money,overseas_percent,year) VALUES ('9','The Lord of the Rings: The Return of the King','NL','1119.9','377.8','33.7%','742.1','66.3%','2003^');
INSERT INTO top_movies(rank,title,studio,worldwide,domestic_money,domestic_percent,overseas_money,overseas_percent,year) VALUES ('10','Skyfall','Sony','1108.6','304.4','27.5%','804.2','72.5%','2012');
INSERT INTO top_movies(rank,title,studio,worldwide,domestic_money,domestic_percent,overseas_money,overseas_percent,year) VALUES ('11','Transformers: Age of Extinction','Par.','1091.4','245.4','22.5%','846.0','77.5%','2014');
INSERT INTO top_movies(rank,title,studio,worldwide,domestic_money,domestic_percent,overseas_money,overseas_percent,year) VALUES ('12','The Dark Knight Rises','WB','1084.4','448.1','41.3%','636.3','58.7%','2012');
INSERT INTO top_movies(rank,title,studio,worldwide,domestic_money,domestic_percent,overseas_money,overseas_percent,year) VALUES ('13','Pirates of the Caribbean: Dead Man''s Chest','BV','1066.2','423.3','39.7%','642.9','60.3%','2006');
INSERT INTO top_movies(rank,title,studio,worldwide,domestic_money,domestic_percent,overseas_money,overseas_percent,year) VALUES ('14','Toy Story 3','BV','1063.2','415.0','39.0%','648.2','61.0%','2010');
INSERT INTO top_movies(rank,title,studio,worldwide,domestic_money,domestic_percent,overseas_money,overseas_percent,year) VALUES ('15','Pirates of the Caribbean: On Stranger Tides','BV','1045.7','241.1','23.1%','804.6','76.9%','2011');
INSERT INTO top_movies(rank,title,studio,worldwide,domestic_money,domestic_percent,overseas_money,overseas_percent,year) VALUES ('16','Jurassic Park','Uni.','1029.2','402.5','39.1%','626.7','60.9%','1993^');
INSERT INTO top_movies(rank,title,studio,worldwide,domestic_money,domestic_percent,overseas_money,overseas_percent,year) VALUES ('17','Star Wars: Episode I - The Phantom Menace','Fox','1027.0','474.5','46.2%','552.5','53.8%','1999^');
INSERT INTO top_movies(rank,title,studio,worldwide,domestic_money,domestic_percent,overseas_money,overseas_percent,year) VALUES ('18','Alice in Wonderland (2010)','BV','1025.5','334.2','32.6%','691.3','67.4%','2010');
INSERT INTO top_movies(rank,title,studio,worldwide,domestic_money,domestic_percent,overseas_money,overseas_percent,year) VALUES ('19','The Hobbit: An Unexpected Journey','WB','1017.0','303.0','29.8%','714.0','70.2%','2012');
INSERT INTO top_movies(rank,title,studio,worldwide,domestic_money,domestic_percent,overseas_money,overseas_percent,year) VALUES ('20','The Dark Knight','WB','1004.6','534.9','53.2%','469.7','46.8%','2008^');
...
top_movies(rank,title,studio,worldwide,domestic_money,domestic_percent,overseas_money,overseas_percent,year) VALUES ('56','The Da Vinci Code','Sony','758.2','217.5','28.7%','540.7','71.3%','2006');
...
/* avg max min ??? from world wide*/




/* AVERAGE of money made worldwide by studios: All of they money divided by number of movies made.
Fox, who achieved a lot of success has it's winnings divided by 13 (movies)

DW, who has only one top_movie sold by 900$ has a better average than Fox */

select studio, AVG(worldwide) as avg_worldwide_$ from top_movies  group by studio order by avg_worldwide_$;

/* SUM of total money made worldwide */

select studio, ROUND(SUM(worldwide)) as sum_worldwide_$ from top_movies group by studio order by  ROUND(SUM(worldwide)) DESC;


/* Search best sold movie worldwide */

select title, max(worldwide) from top_movies;
/* Search worst sold movie worldwide */
select title, min(worldwide) from top_movies;
